...
chains are fully traversable ($\rho$ grows with slope $1$). Exact computation
(Section~\ref{sec:comp}) gives
...
main theorem has a second proof in Appendix~\ref{app:trap}.
