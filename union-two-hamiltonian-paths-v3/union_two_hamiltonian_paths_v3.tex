...
%% [E6 cut 2026-07-27] Appendix A "A second construction: trap chains"
%% (app:trap) removed in full: def:chain, lem:chain-inv, lem:chain-visit,
%% lem:trap (Trap Lemma), thm:trap-main, rem:trap-data. Stale refs remain
%% (per the stale-ref policy, logged in edit ledger E6, NOT fixed here):
%% Sec 1 intro "second, independent construction" paragraph; sec:comp
%% Implementations "trap-family values of Appendix at six points"; sec:disc
%% "or from the chains of Appendix..."; Acknowledgments "second proof in
%% Appendix..."; ancillary code/ trap files (check_trap.log etc.).
