...
Section~\ref{sec:disc} collects what remains of the lower-bound question: even
...
solver (also in the artifact), independently written, which agrees with the
...
independently of the C++ censuses of item~7; see Appendix~\ref{app:census}.
...
Items 1--7 and 9--10 are exhaustive or certified within their stated ranges and
...
lower bounds at all, while Theorem~\ref{thm:main} caps everything at
...
intuition precise, and the census of Appendix~\ref{app:census} together with
Proposition~\ref{prop:k3} (three orderings suffice through $n = 10$ and fail at
$n = 11$) warns that small-$n$ exhaustive evidence is weak evidence in this
problem family. A disproof -- a family with $\rho$ bounded -- would be at least
...
family, found and verified independently of the main text. It does not use
...
\section{A concise \texorpdfstring{$\pmin$}{rho-min} census}\label{app:census}
...
enumeration (the joint $(b, \rho)$ censuses of Section~\ref{sec:comp}, logs
\texttt{exh7.txt}--\texttt{exh12.txt}). For $n \le 6$ every union is
...
$\pmin(11) = 7 < 8 = \pmin(10)$, and the values at $n = 7, 11$ sit below both
neighbors. Second, the deficient sets remain a vanishing fraction of $S_n$
throughout the range ($|D(12)|/12! \approx 0.25\%$), while their internal
